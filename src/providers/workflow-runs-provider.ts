...
import { getWorkflowRuns, getWorkflowRunJobs, cancelWorkflowRun, rerunWorkflowRun, rerunFailedJobs } from '../api/workflow-monitor';
...
export class WorkflowRunsProvider implements vscode.WebviewViewProvider {
     ...
     */
    private async _sendWorkflowRuns(options?: { workflowId?: number; branch?: string; status?: string }) {
        const config = getConfig();
    ...
    private _getHtmlForWebview(webview: vscode.Webview) {
        ...
        const scriptUri = webview.asWebviewUri(vscode.Uri.joinPath(this._extensionUri, 'dist', 'workflow-runs.js'));
